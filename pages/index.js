  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="twitter:title"
          content="Aninow - Free Anime and Manga Streaming"
        />
        <meta
          name="twitter:description"
          content="Discover your new favorite anime or manga title! Aninow offers a vast library of high-quality content, accessible on multiple devices and without any interruptions. Start using Aninow today!"
        />
        <meta
          name="twitter:image"
